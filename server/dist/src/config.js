...
exports.PORT = exports.MAINNET_DISALLOWED_RECIPIENTS = exports.ENDPOINT = exports.FEE = exports.MIN_TX_PROFIT = exports.FORWARDER_CONTRACT = exports.REGISTRY_CONTRACT = exports.TESTNET_RPC_URL = exports.PRIVATE_KEY = void 0;
const dotenv = __importStar(require("dotenv"));
dotenv.config();
exports.PRIVATE_KEY = `${String(process.env.PRIVATE_KEY)}`;
exports.TESTNET_RPC_URL = String(process.env.TESTNET_RPC_URL);
